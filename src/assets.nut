...
sprMidi <- newSprite("klc/midi.png", 32, 32, 16, 19);
defMidi <- sprMidi;
sprMidiOverworld <- newSprite("klc/midiO.png", 14, 21, 7, 17);
defMidiOverworld <- sprMidiOverworld;
sprMidiDoll <- newSprite("klc/mididoll.png", 16, 16, 8, 8);
defMidiDoll <- sprMidiDoll;
sprMidiNPC <- newSprite("klc/midi-npc.png", 32, 32, 16, 32);
sprMidiAura <- newSprite("klc/midi-aura.png", 32, 32, 16, 19);
...
sprDuke <- newSprite("klc/duke.png", 32, 32, 16, 32);
...
sprDukeCrusher <- newSprite("klc/duke-crusher.png", 32, 32, 16, 16);
...
sprNutBomb <- newSprite("klc/nutbomb.png", 8, 8, 4, 4);
defNutBomb <- sprNutBomb;
sprNutBomb2 <- newSprite("klc/nutbomb2.png", 16, 16, 8, 8);
defNutBomb2 <- sprNutBomb2;
sprNutBomb3 <- newSprite("klc/nutbomb3.png", 16, 16, 8, 8);
defNutBomb3 <- sprNutBomb3;
sprTopNut <- newSprite("klc/topnut.png", 16, 16, 8, 9);
defTopNut <- sprTopNut;
sprWingNut <- newSprite("klc/wingnutbomb.png", 16, 16, 8, 8);
defWingnut <- sprWingNut;
sprNutMine <- newSprite("klc/nutmine.png", 16, 16, 8, 12);
...
sndMidiJump <- loadSound("klc/midi-jump.ogg");
